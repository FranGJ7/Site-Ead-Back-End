...
export const authController = {
  register: async (req: Request, res: Response) => {
    const { firstName, lastName, email, password, birth, phone } = req.body //body pode vir de varios formatos diferentes alterar em server
  ...
  login: async (req: Request, res: Response) => {
    ...
    try {
      const user = await userService.finByEmail(email)
